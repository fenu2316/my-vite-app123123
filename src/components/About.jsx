...
// import a1 from"../assets/img/a111.jpg"
...
export default function About(){
    return(
        ...
        <div style={{display:"flex"}}>
            <div style={{height:"700px", width:"60%", backgroundColor:"black",textAlign:"center"}}>
            ...
            <div style={{fontSize:"26px",textAlign:"left",wordSpacing:"3px",
                ...
                <span style={{ color:"purple",paddingTop:"5px"}}> 
                Soni Feni</span>
                <span style={{ color:"white",paddingTop:"5px"}}>
                from  </span>
                <span style={{color:"purple",paddingTop:"5px"}}> 
                Ahemedabad,India.   </span>
                <span style={{ color:"white",paddingTop:"5px"}}>
                   I am currently employed as a software developer at Juspay.I have 
                   completed Integrated MSc (IMSc) in Maths and Computing at BIT Mesra.</span>
            

                </div>
            <div style={{fontSize:"26px",textAlign:"left",marginTop:"25px",marginLeft:"10px"}}>
                    <span style={{ color:"white",paddingTop:"5px"}}>
                            Apart from coding, some other activities that I love to do!
                    </span>
            </div>
            <div style={{color:"white",paddingTop:"5px",fontSize:"26px",textAlign:"left",
                marginTop:"25px",marginLeft:"100px"}}>
                <p>Playing Games</p>
            ...
            <div style={{height:"700px", width:"40%", backgroundColor:"black"}}>
                <img style={{paddingTop:"200px"}} src={about}></img>
            </div>
        </div>
        <div>
            <div style={{height:"100px",width:"100%",backgroundColor:"black",fontSize:"40px",textAlign:"center"}}> 
                <span style={{ color:"white",paddingTop:"5px"}}>
                Professional  </span>
                <span style={{color:"purple",paddingTop:"5px"}}> 
                Skillset   </span>
        ...
        <div>
           <div>
                <div style={{ backgroundColor: "black", height: "600px", width: "100%", display:"flex",
                gap:"50px",flexWrap:"wrap", alignItems: "center", 
                justifyContent: "center" }}>

                    <div style={{ width: "200px", height: "150px", border: "3px solid purple",borderRadius: "5px", display:"flex",justifyContent:"center",alignItems:"center"}}>
                    <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" 
                    height="80px" width="100px" color="white" 
                    ...
                    <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" 
                     height="80px" width="100px" color="white" 
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M15.695 14.305c1.061 1.06 2.953 .888 4.226 -.384c1.272 -1.273 1.444 -3.165 .384 -4.226c-1.061 -1.06 -2.953 -.888 -4.226 .384c-1.272 1.273 -1.444 3.165 -.384 4.226z"></path><path d="M12.68 9.233c-1.084 -.497 -2.545 -.191 -3.591 .846c-1.284 1.273 -1.457 3.165 -.388 4.226c1.07 1.06 2.978 .888 4.261 -.384a3.669 3.669 0 0 0 1.038 -1.921h-2.427"></path><path d="M5.5 15h-1.5"></path><path d="M6 9h-2"></path><path d="M5 12h-3"></path></svg>
                    ...
                    <path d="M3.89 15.672L6.255.461A.542.542 0 017.27.288l2.543 4.771zm16.794 3.692l-2.25-14a.54.54 0 00-.919-.295L3.316 19.365l7.856 4.427a1.621 1.621 0 001.588 0zM14.3 7.147l-1.82-3.482a.542.542 0 00-.96 0L3.53 17.984z"></path></svg>
